...
# user super class
# teach and student sub classes
# class attribute to track all user names
# class methods to add users and to find a specific user

# User, Teacher, Student

# User
# Attributes: First Name, Last Name, Emails
# Methods: send_email
# Class Attributes: all_names
# Class Methods: add_name_to_all, user_exists

# Teacher: Knowledge attribute, teach Method
# Student: GPA, Knowledge attributes and learn Method
...
class User:
  ...
  def user_exists(cls, fullname):
    return fullname in cls.all_names # name in all_name ? T or F
...
sandy = Teacher("Sandy", "Williams", "sandy.williams@uni.edu")
